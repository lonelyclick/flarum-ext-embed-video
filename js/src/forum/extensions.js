...
export const extensions = [
    {
        attributeName: 'Dash',
        url: 'https://www.yuanjuechan.com/static/js/dash.all.min.js',
    ...
    {
        attributeName: 'Flv',
        url: 'https://www.yuanjuechan.com/static/js/flv.min.js',
    ...
    {
        attributeName: 'Hls',
        url: 'https://www.yuanjuechan.com/static/js/hls.min.js',
    ...
    {
        attributeName: 'Shaka',
        url: 'https://www.yuanjuechan.com/static/js/mux.min.js',
    ...
    {
        attributeName: 'Shaka',
        url: 'https://www.yuanjuechan.com/static/js/shaka-player.compiled.js',
    ...
    },
    {
        ...
        url: 'https://www.yuanjuechan.com/static/js/webtorrent.min.js',
